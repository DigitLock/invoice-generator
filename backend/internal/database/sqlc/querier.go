...
type Querier interface {
	...
	CountInvoices(ctx context.Context, familyID int32) (int64, error)
	...
	ListClients(ctx context.Context, familyID int32) ([]Client, error)
	ListClientsByStatus(ctx context.Context, arg ListClientsByStatusParams) ([]Client, error)
	ListCompanies(ctx context.Context, familyID int32) ([]Company, error)
